...
<jsp:directive.include file="/WEB-INF/jsp/header.jsp"/>
    <form:form action="/FinanceManager/person" method="POST" modelAttribute="person">
        <div>
            ...
            <form:input cssStyle="width:250px" maxlength="30" path="firstName" size="30"/><form:errors path="firstName" cssClass="errors"/>
        ...
        <br/>
          <div>          	
            ...
            <form:input cssStyle="width:250px" maxlength="30" path="lastName" size="30"/><form:errors path="lastName" cssClass="errors"/>
        ...
        <div>        	
            ...
            <form:input cssStyle="width:250px" maxlength="30" path="email" size="30"/><form:errors path="email" cssClass="errors"/><br/>
        ...
        <div>        	
            ...
            <form:input cssStyle="width:250px" maxlength="30" path="address.streetName" id="streetName" size="30"/><form:errors path="address.streetName" cssClass="errors"/><br/>
        ...
        <div>        	
            ...
            <form:input cssStyle="width:250px" maxlength="30" path="address.streetNumber" id="streetNumber" size="30"/><form:errors path="address.streetNumber" cssClass="errors"/><br/>
        ...
        <div>        	
            ...
            <form:input cssStyle="width:250px" maxlength="30" path="address.city" id="city" size="30"/><form:errors path="address.city" cssClass="errors"/><br/>
        ...
        <div>        	
            ...
            <form:input cssStyle="width:250px" maxlength="30" path="address.zipCode" id="zipCode" size="30"/><form:errors path="address.zipCode" cssClass="errors"/><br/>
        ...
        <div>        	
            ...
            <form:input cssStyle="width:250px" maxlength="30" path="address.state" id="state" size="30"/><form:errors path="address.state" cssClass="errors"/><br/>
        ...
        <div>        	
            ...
            <form:input cssStyle="width:250px" maxlength="30" path="address.country" id="country" size="30"/><form:errors path="address.country" cssClass="errors"/>
