...
<jsp:directive.include file="/WEB-INF/jsp/header.jsp"/>
    <form:form action="/FinanceManager/person/${person.id}" method="PUT" modelAttribute="person">
        ...
        <div>
            ...
            <form:input cssStyle="width:250px" maxlength="30" path="email" size="30"/><form:errors path="email" cssClass="errors"/>
        ...
        <div>
            ...
            <form:input cssStyle="width:250px" maxlength="30" path="address.streetName" id="streetName" size="30"/><form:errors path="address.streetName" cssClass="errors"/>
        ...
        <div>
            ...
            <form:input cssStyle="width:250px" maxlength="30" path="address.streetNumber" id="streetNumber" size="30"/><form:errors path="address.streetNumber" cssClass="errors"/>
        ...
        <div>
            ...
            <form:input cssStyle="width:250px" maxlength="30" path="address.city" id="city" size="30"/><form:errors path="address.city" cssClass="errors"/>
        ...
        <div>
            ...
            <form:input cssStyle="width:250px" maxlength="30" path="address.zipCode" id="zipCode" size="30"/><form:errors path="address.zipCode" cssClass="errors"/>
        ...
        <div>
            ...
            <form:input cssStyle="width:250px" maxlength="30" path="address.state" id="state" size="30"/><form:errors path="address.state" cssClass="errors"/>
